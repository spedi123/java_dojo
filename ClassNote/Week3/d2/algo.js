 ...
 */
 class MinHeap {
  ...
  let firstMiniHeap = new MinHeap();
  firstMiniHeap.insert(3)
  firstMiniHeap.insert(6)
  firstMiniHeap.insert(7)
  firstMiniHeap.insert(8)
  firstMiniHeap.insert(9)
  firstMiniHeap.insert(10)
  firstMiniHeap.insert(22)

  firstMiniHeap.extract();
  console.log(firstMiniHeap.printHorizontalTree())